import img2 from "../../assets/logo-local-brand/HR SHOPIN LOGO MEN.png";
import img3 from "../../assets/image-home-all-brand/image-for-hr-women.png";
import HRCartforwomen from "./HRCartforwomen";
...
const hrWomen = () => {
  return (
    <div>
      ...
      <a className="back-brand-home" href="/hrHome">
