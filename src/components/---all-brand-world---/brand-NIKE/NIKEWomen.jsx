import img2 from "../../../assets/logo-world-brand/nike-logo-home-men.png";
import img3 from "../../../assets/image-home-all-brand/image-NIKE-for-women.jpeg";
import NIKEcartforWomen from "./NIKEcartforWomen";
...
const NIKEWomen = () => {
  return (
    <div>
      ...
      >
        <img style={{ maxWidth: "88px" }} src={img2} />
      ...
      <a className="back-brand-home" href="/NIKEHome">
