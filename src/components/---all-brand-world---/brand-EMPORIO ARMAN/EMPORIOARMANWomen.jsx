import img2 from "../../../assets/logo-world-brand/EMPORIO ARMAN-logo-men-home.png";
import img3 from "../../../assets/image-home-all-brand/image-EMPORIO ARMAN-for-women.jpeg";
import EMPORIOARMANcartforWomen from "./EMPORIOARMANcartforWomen";
import Footer from "../../footer";
const EMPORIOARMANWomen = () => {
  return (
    <div>
      <header
        data-aos="fade-down"
      ...
      >
        <img style={{ maxWidth: "260px" }} src={img2} />
      ...
      <a className="back-brand-home" href="/EMPORIOARMANHome">
      ...
      <br />
      <br />
      {/* you need add flie in all brand and this brand for all cart women */}
      <EMPORIOARMANcartforWomen />
      <br />
      <br />
      <br />
      <br />
...
export default EMPORIOARMANWomen;
