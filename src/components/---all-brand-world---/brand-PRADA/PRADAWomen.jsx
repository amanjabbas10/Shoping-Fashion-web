import img2 from "../../../assets/logo-world-brand/PRADA-logo-men-home.png";
import img3 from "../../../assets/image-home-all-brand/image-PRADA-for-women.jpeg";
import PRADAcartforWomen from "./PRADAcartforWomen";
...
const PRADAWomen = () => {
  return (
    <div>
      ...
      >
        <img style={{ maxWidth: "100px" }} src={img2} />
      ...
      <a className="back-brand-home" href="/PRADAHome">
