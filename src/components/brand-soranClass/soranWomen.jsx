import img2 from "../../assets/logo-local-brand/SORAN CLASS-MEN -HOME-LOGO.png";
import img3 from "../../assets/image-home-all-brand/soran class for women.jpeg";
import SorancartforWomen from "./sorancartforWomen";
...
const soranWomen = () => {
  return (
    <div>
      ...
      <a className="back-brand-home" href="/soranHome">
