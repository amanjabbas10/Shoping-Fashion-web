import img2 from "../../assets/logo-local-brand/LOGO-HOME-MEN-BUSNESS.png";
import img3 from "../../assets/image-home-all-brand/image-home-bsiness.png";
import CartAllbrand from "./cartAllbrand";
  ...
  return (
    <div>
      ...
      <nav data-aos="fade-down" data-aos-duration="2500" className="navbar-two">
        ...
        <a href="#Shirt">
          <i class="ph ph-shirt-folded"></i> Shirts
        </a>
        <a href="#T-Shirt">
          <i class="ph ph-t-shirt"></i> T-Shirts
        </a>
        <a href="#Jeans">
          <i className="ph ph-pants"></i> Jeans
        </a>
        <a href="#Jacket">
          <i class="ph ph-hoodie"></i> Jackets
        </a>
        <a href="#Shoes">
      ...
      <a className="back-brand-home" href="/bussnisHome">
