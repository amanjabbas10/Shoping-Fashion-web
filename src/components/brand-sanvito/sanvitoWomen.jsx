import img2 from "../../assets/logo-local-brand/SAN VITO-MEN-LOGO.png";
import img3 from "../../assets/image-home-all-brand/image-home-SAN VITO-women.png";
import SanvitocartforWomen from "./sanvitocartforWomen";
...
const sanvitoWomen = () => {
  return (
    <div>
      ...
      >
        <img style={{ maxWidth: "140px" }} src={img2} />
      ...
      <a className="back-brand-home" href="/sanvitoHome">
