import img2 from "../../assets/logo-local-brand/SHVAN-MEN-LOGO.png";
import img3 from "../../assets/image-home-all-brand/image-for-women-shvan center.png";
import ShvancartforWomen from "./shvancartforWomen";
...
const shvanWomen = () => {
  return (
    <div>
      ...
      <a className="back-brand-home" href="/shvanHome">
